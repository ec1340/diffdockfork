...
print("(in so3.py) Loading SO(3) precomputed data...")
if os.path.exists('.so3_omegas_array4.npy'):
    ...
    print("(in so3.py) SO(3) precomputed data loaded successfully.")    


else:
    print("(in so3.py) SO(3) precomputed data not found, computing...")
